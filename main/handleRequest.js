...
export default function handleRequest(req, server, url, diesel) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let routeHandler = diesel.trie.search(url.pathname, req.method);
        ...
        if (diesel.corsConfig) {
            const corsResult = yield applyCors(req, ctx, diesel.corsConfig);
            if (corsResult)
                return corsResult;
        }
        // OnReq hook 1
        ...
        if (diesel.hasMiddleware) {
            ...
            for (const middleware of middlewares) {
                const result = yield middleware(ctx, server);
                if (result)
                    return result;
            }
        }
...
function applyCors(req_1, ctx_1) {
    return __awaiter(this, arguments, void 0, function* (req, ctx, config = {}) {
        var _a, _b, _c, _d, _e;
