import { type HonoRequest, type Env, type TypedResponse } from "hono"
import type { Result } from "hono/router"
import type { FetchEventLike, H, Input, NotFoundHandler, RouterRoute } from "hono/types"
...
> {
  ...
  get req(): HonoRequest<P, I['out']> {
    ...
    return this.#req as HonoRequest<P, I['out']>
  }
...
//     // this.#renderer ??= (content: string | Promise<string>) => this.text(content)
...
//   }
  ...
  notFound = (): ReturnType<NotFoundHandler> => {
    ...
    return {} as ReturnType<NotFoundHandler>
  }
}